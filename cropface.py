...
if __name__ =="__main__":  
      ...
      for line in f:
            ...
            CropFace(image, eye_left=(leftx,lefty), eye_right=(rightx,righty), offset_pct=(0.25,0.35), dest_sz=(136,168)).save("/media/fangxuyang/F/firefoxdownload/CK+database/augcropped/"+str(num-1)+".bmp")  
            print(num-1)
            #CropFace(image, eye_left=(leftx,lefty), eye_right=(rightx,righty), offset_pct=(0.2,0.2), dest_sz=(136,168)).save("test_10_10_200_200.jpg")  

            #CropFace(image, eye_left=(leftx,lefty), eye_right=(rightx,righty), offset_pct=(0.25,0.25), dest_sz=(136,168)).save("test_30_30_200_200.jpg")  
            #CropFace(image, eye_left=(leftx,lefty), eye_right=(rightx,righty), offset_pct=(0.4,0.4), dest_sz=(136,168)).save("test_40_40_200_200.jpg")  
            #CropFace(image, eye_left=(leftx,lefty), eye_right=(rightx,righty), offset_pct=(0.45,0.45), dest_sz=(136,168)).save("test_45_45_200_200.jpg")  
